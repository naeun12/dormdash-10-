    ...
    <nav class="navbar navbar-expand-lg bg-white py-3">
        <div class="container navigation-style">
            ...
            <div class="d-none d-lg-flex gap-2 ms-3">
                <a href="{{route('login-tenant')}}" class="btn fw-bold px-4 rounded-pill shadow-sm disabled" 
                   style="background: #e9ecef; color: #6c757d; border: none;">Resident</a>
                
                <a href="{{ route('landlord-Login') }}" class="btn text-white fw-bold px-4 rounded-pill shadow-sm landlord-btn" 
                   style="background: #FC7D07; border: none; transition: 0.3s;">Property Owner</a>
            </div>
        </div>
    </nav>
